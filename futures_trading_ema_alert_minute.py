...
class Signals:
    ...
    def decide(self):
        ...
        self.df['Sell'] = np.where((self.df.trigger) & (self.df['%K'].between(20,80)) & (self.df['%D'].between(20,80)) & (self.df.ema10 < self.df.ema100) & (self.df.ema10 < self.df.ema150) & (self.df.ema100 < self.df.ema150) & (self.df.macd < 0) & (self.df.rsi < 50), 1, 0)
        ...
        self.df['emaSELL1'] = np.where((self.df.trigger) & (self.df.ema10 < self.df.ema150), 1, 0)
        ...
        self.df['TPBUY1'] = np.where((self.df.trigger) & (self.df.ema10 < self.df.ema100) & (self.df.rsi < 50), 1, 0)
        ...
        self.df['TPBUY3'] = np.where((self.df.trigger) & (self.df.macd < 0) & (self.df.ema10 < self.df.ema100), 1, 0)

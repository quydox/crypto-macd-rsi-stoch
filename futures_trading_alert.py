...
class Signals:
    ...
    def decide(self):
        ...
        self.df['SellRule1'] = np.where((self.df.trigger) & (self.df['%K'] > 70) & (self.df['%D'] > 70) & (self.df.rsi > 70), 1, 0)
        self.df['BuyRule1'] = np.where((self.df.trigger) & (self.df['%K'] < 30) & (self.df['%D'] < 30) & (self.df.rsi < 30), 1, 0)

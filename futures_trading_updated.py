...
class Signals:
    ...
    def decide(self):
        ...
        self.df['Sell'] = np.where((self.df.trigger) & (self.df['%K'].between(20,80)) & (self.df['%D'].between(20,80)) & (self.df.macd < -1) & (self.df.ema < df.Close), 1, 0)
...
while True:
    ...
    for coins in crypto_coins:
        #try:
        df = getminutedata(coins, '5m', "1 day ago UTC")

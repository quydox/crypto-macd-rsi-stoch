            ...
            if check_balance['asset'] == "USDT":
                ...
                if df.Buy.iloc[-1]:
                    ...
                    if pair not in clean_buy_list and float(open_position_check['entryPrice']) == 0:
                        order = client.futures_create_order(symbol=pair, side='BUY', type='MARKET', quantity=qty, leverage=25)
                    ...
                    if pair not in clean_sell_list and float(open_position_check['entryPrice']) == 0:
                        ...
                        for item in fees:
                            ...
                            order = client.futures_create_order(symbol=pair, side='SELL', type='MARKET', quantity=qty_order, leverage=25)

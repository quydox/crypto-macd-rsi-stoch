        ...
        if check_balance['asset'] == "BUSD":
            ...
            if df.Buy.iloc[-1]:
                ...
                if pair not in clean_buy_list:
                    order = client.futures_create_order(symbol=pair,side='BUY',type='STOP_MARKET',quantity=qty,leverage=20,icebergQty=stop_market_buy_price)
                    open_position = True
                ...
                if pair not in clean_sell_list:
                    ...
                    for item in fees:
                        ...
                        order = client.futures_create_order(symbol=pair,side='SELL',type='STOP_MARKET',quantity=qty_order,leverage=20,icebergQty=stop_market_sell_price)

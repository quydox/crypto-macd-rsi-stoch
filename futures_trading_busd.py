...
class Signals:
    ...
    def decide(self):
        ...
        self.df['TPBUY2'] = np.where((self.df.trigger) & (self.df.uptrend.iloc[-1]) & (self.df.downtrend.iloc[-1]) & (self.df.macd < 0), 1, 0)
        self.df['TPSELL2'] = np.where((self.df.trigger) & (self.df.uptrend.iloc[-1]) & (self.df.downtrend.iloc[-1]) & (self.df.macd > 0), 1, 0)
